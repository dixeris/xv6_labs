    ...
    100a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    1017:	52                   	push   %edx
    1018:	52                   	push   %edx
    1019:	68 28 18 00 00       	push   $0x1828
    101e:	6a 02                	push   $0x2
    1020:	e8 9b 04 00 00       	call   14c0 <printf>
    exit();
  ...
  exit();
    ...
    1049:	68 3b 18 00 00       	push   $0x183b
    104e:	6a 02                	push   $0x2
    ...
    141c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1449:	0f b6 92 58 18 00 00 	movzbl 0x1858(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1644:	eb 1a                	jmp    1660 <printf+0x1a0>
          s = "(null)";
    1646:	bb 4f 18 00 00       	mov    $0x184f,%ebx
        while(*s != 0){
    ...
    1691:	a1 50 1b 00 00       	mov    0x1b50,%eax
{
  ...
  freep = p;
    ...
    16d1:	5b                   	pop    %ebx
  freep = p;
    16d2:	89 15 50 1b 00 00    	mov    %edx,0x1b50
}
    16d8:	5e                   	pop    %esi
    16d9:	5f                   	pop    %edi
    16da:	5d                   	pop    %ebp
  ...
  freep = p;
    170c:	89 15 50 1b 00 00    	mov    %edx,0x1b50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    172c:	8b 3d 50 1b 00 00    	mov    0x1b50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1779:	8b 3d 50 1b 00 00    	mov    0x1b50,%edi
  ...
  return freep;
    17a7:	a1 50 1b 00 00       	mov    0x1b50,%eax
    ...
    17d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    17d7:	a3 50 1b 00 00       	mov    %eax,0x1b50
}
    ...
    base.s.ptr = freep = prevp = &base;
    17f0:	c7 05 50 1b 00 00 54 	movl   $0x1b54,0x1b50
    17f7:	1b 00 00 
    base.s.size = 0;
    17fa:	bf 54 1b 00 00       	mov    $0x1b54,%edi
    base.s.ptr = freep = prevp = &base;
    17ff:	c7 05 54 1b 00 00 54 	movl   $0x1b54,0x1b54
    1806:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    180b:	c7 05 58 1b 00 00 00 	movl   $0x0,0x1b58
    1812:	00 00 00 
    if(p->s.size >= nunits){
